...
- [P-KAN: Projective Kolmogorov–Arnold Networks](https://arxiv.org/abs/2509.20049) (2025) : Pre-print. Applying representation theory coupled with signal processing & taking an unconventional look at the universal approximation theorem, we are able to discover latent structure within the functional spaces of each edge and reduce the parameter space by up to 83%, while maintaining or improving accuracy with starndard or noisy training data. 
...
- [KAGAT](https://github.com/Xkzysheng/KAGAT-Kolmogorov-Arnold-Graph-Attention-Network): KAGAT: KAN-based Graph Attention Network (GAT) with different architectures. | ![Github stars](https://img.shields.io/github/stars/Xkzysheng/KAGAT-Kolmogorov-Arnold-Graph-Attention-Network.svg)
...
- [KANX (Mattral)](https://github.com/Mattral/KANX) : Production-grade Kolmogorov-Arnold Network library supporting TensorFlow + PyTorch backends with ONNX export, FastAPI REST service, and Docker/Kubernetes deployment. | ![Github stars](https://img.shields.io/github/stars/Mattral/KANX.svg)
...
- [Semantic Motion Generation](https://github.com/vonexel/smog) - The PyTorch Implementation of Text-to-3D-Motion Synthesis Leveraging CLIP Semantics and KAN-enhanced Transformers. ｜ ![Github stars](https://img.shields.io/github/stars/vonexel/smog.svg)
