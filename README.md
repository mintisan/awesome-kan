...
- [KANQAS: Kolmogorov-Arnold Network for Quantum Architecture Search](https://arxiv.org/abs/2406.17630) | [code](https://github.com/Aqasch/KANQAS_code) ｜ ![Github stars](https://img.shields.io/github/stars/aqasch/KANQAS_code.svg): The work introduces the application of Kolmogorov-Arnold Networks (KANs) in quantum architecture search (QAS) to optimize and automate the design of quantum circuits. The study compares KANs with traditional Multi-Layer Perceptrons (MLPs) in tasks such as quantum state preparation and quantum chemistry problems. Key findings include: (1) KANs achieve higher success rates and better fidelity in generating maximally entangled states, especially in noisy scenarios, and (2) require fewer learnable parameters. However, (3) KANs take longer to execute each episode compared to MLPs. By integrating KANs with Curriculum Reinforcement Learning, the researchers improved the efficiency of finding the ground state of chemical Hamiltonians with shallower and more parameter-efficient quantum circuits. 
