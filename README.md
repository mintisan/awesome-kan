...
- [2s-KAGCN](https://github.com/gguzzy/2s-KAGCN): Two-Stream Adaptive Kolmogorov-Arnold Network Graph Convolutional Networks for Skeleton-Based Action Recognition | ![Github stars](https://img.shields.io/github/stars/gguzzy/2s-KAGCN.svg)
